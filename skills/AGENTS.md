...
Skills are reusable workflow templates that can be invoked via `/omc:skill-name`. Each skill provides:
...
- Test skill invocation with `/omc:skill-name`
