...
omc v${updateInfo.latestVersion} is available (current: v${updateInfo.currentVersion}).
...
A new version of omc is available: v${updateInfo.latestVersion} (current: ${updateInfo.currentVersion})
